...
/**
 * The "what happened" line — the one sentence that tells you whether you'd
 * want this row back.
 *
 ...
 * already approved and copied — and a /done list that misreports what
 * happened is a /done list nobody trusts to undo from.
 */
