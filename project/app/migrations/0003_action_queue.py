"""The actions engine: the tenant -> catalog join and the per-lead work queue.

Additive and schema-only: two new tables plus the job/event through table.
...
# Generated by Django 4.2.30 on 2026-09-17 15:17
